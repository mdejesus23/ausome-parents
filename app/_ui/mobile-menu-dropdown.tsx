      ...
      <div className="px-4 py-6">
        ...
        <div className="mt-4 border-t border-gray-100 pt-4">
          <a
            ...
            className="flex items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 hover:text-blue-600"
            role="menuitem"
          >
            <svg
